...
const STOPS: Record<string, CameraStop> = {
  hero: {
    ...
    target: [-11.6390742412669, 8, -6.266541083914141],
  },
  about: {
    position: [21.06552208419172, 18.880947281449835, -8.568923047263391],
    target: [19.924294976753323, 0.5007008137690914, -8.975348972894503],
  },
  projects: {
